...
<body onload="display_ct();"  style="min-width: 100%;background-color: #f5f5f5; position: fixed; height:100%;">
<audio id="audio-alerta" src="sound/painel.mp3"></audio>
<table class="main-wrapper" style="border-collapse: collapse;border-spacing: 0;display: table;table-layout: fixed; -webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;text-rendering: optimizeLegibility;background-color: #f5f5f5; width: 100%;">
        <tbody>
            <tr>
            ...
            <table class="main-content" style="width: 100%; border-spacing: 0;margin-left: auto;margin-right: auto; border: 1px solid #EAEAEA; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; background-color: #ffffff; overflow: hidden;" width="1000">
                <tbody>
                    <tr>
                                            ...
                                            <tr>
                                                ...
                                                <div class="body-copy" style="margin: 0;">
                                                    ...
                                                    <div style="margin: 0;color: #60666d;font-size: 50px;font-family: sans-serif;line-height: 20px; text-align: left;">
														...
														<iframe class="video" scrolling="no" src="https://ekostreams.co/ch/bobo.php" frameborder="0" style="margin-top: 3%; overflow:hidden; height:80vh; width:76%" allowfullscreen="" ></iframe>
															<!-- 
